...
- `2026-08-31-higiene-taladro-40` — Claude Fable 5 — add-node — higiene (precision enum, 16 conos re-trazados src_ids, 20 notas capital≠polidad) + taladro 40 nodos; árbol 2296→2336 / ontología 2522→2562 — [log](2026-08-31_historia-modelada-html.md)
...
- `2026-08-31-skill-repo` — Grok 4.6 — repo-push — repo público ManuelCadena/sota-agent-heartbeat; scripts pendientes por lock — [log](2026-08-31_skill-repo.md)
